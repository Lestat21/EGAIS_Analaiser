...
namespace EGAIS_Analaiser.ParserXLSX
{
    public static class ParserEGAIS
    {
        ...
        public static void ParserZagotovkaEGAIS(string filePath) // парсер оперативного учета ЕГАИС
        {
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
        ...
        public static void ParserSkladEGAIS(string filePath) // парсер складов ЕГАИС
        {
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
        ...
        public static void ParserTDLes(string filePath) // парсер учетных документов ЕГАИС
        {
            ExcelPackage.LicenseContext = LicenseContext.NonCommercial;
